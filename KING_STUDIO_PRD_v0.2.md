...
| K-Pop Making Class (전 언어) | 2시간 / 2슬롯 (평일만) | 10–12, 14–16 |

> **단체(Making Class) 슬롯 예외**: Making Class는 평일 10:00·14:00 2슬롯만 운영한다. **사유: 주말 및 그 외 시간대는 고단가 개인 패키지(Gold·Diamond·Premium) 우선 배정 정책에 따라 단체에 미개방.** Making은 전세(1팀 룸 점유)이나 룸 종일 독점이 아니며, 같은 평일 같은 룸의 비점유 시간대(예: 12–14, 16–22)는 개인 예약에 개방한다. 멀티룸 전환 시 룸별로 이 정책을 재설정할 수 있다.
