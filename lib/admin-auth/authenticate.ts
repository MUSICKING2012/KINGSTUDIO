...
import { ADMIN_LOCKOUT_MS, ADMIN_LOCKOUT_THRESHOLD } from './constants';
...
export async function authenticateAdmin(
  ...
  const totpOk =
    pwOk && admin.totpSecret ? verifyTotp(decryptSecret(admin.totpSecret), totp) : false;
